  ...
  context "po zalogowaniu" do
    include_context "user login"
      ...
      before :each do
        ...
        Submission.create!(person: Person.first, status: "nadesłany", polish_title: "Ulisses", received: '29-02-2016', english_title: "Ulisses", english_abstract: "A tale of a man", english_keywords: "ulisses", language: "polski")
