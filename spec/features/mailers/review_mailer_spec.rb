...
feature "Zapytanie" do
  ...
  context "po zalogowaniu" do
    ...
    background do
      Person.create!(name: "Joanna", surname: "Gąska", email: "sz4n14@gmail.com", sex: "kobieta", roles: ['redaktor','recenzent'], discipline: ["psychologia"])
      ...
      ArticleRevision.create!(version: "1.0", received: "21-01-2016", pages: "10", article: article_file, submission: Submission.first)
